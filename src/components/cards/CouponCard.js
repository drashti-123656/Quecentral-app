    ...
    <LinearGradient
      ...
      <View>
        <View
          ...
          <Text style={styles.h1}>Code: {name}</Text>
          <TouchableOpacity onPress={copyToClipboard}>
            <Text style={{...styles.h1, color: '#FFD700'}}>
              Copy
            </Text>
          </TouchableOpacity>
        </View>
        <View style={{flexDirection: 'row'}}>
          ...
          <Text style={{...styles.h1, marginLeft: 115}}>
            Discount: {discount} % OFF
          </Text>
        </View>
        <View style={{flexDirection: 'row'}}>
          <Text selectable={true} style={styles.h1}>
            Already used:{used_coupon}
          </Text>
          <Text style={{...styles.h1, marginLeft: 79}}>
